...
import com.algarworks.osworks.api.model.ComentarioInput;
import com.algarworks.osworks.api.model.ComentarioModel;
...
public class ComentarioController {
    ...
    public List<ComentarioModel> listar(@PathVariable Long ordemServicoId) {
        OrdemServico ordemServico = ordemServicoRepository.findById(ordemServicoId)
            .orElseThrow(() -> new EntidadeNaoEncontradaException("Ordem de serviço não enrontrada"));
